...
if arch ~= "avx2" and arch ~= "avx512" then
	...
	if string.sub(lang,1,2) == "fr" then
		LmodError("L'environnement StdEnv/2026 n'est pas disponible pour l'architecture " .. arch .. ".")
	else
		LmodError("The StdEnv/2026 environment is not available for architecture " .. arch .. ".")
	end
end
...
assert(loadfile("/cvmfs/soft.computecanada.ca/custom/modules/gentoo/2026.lua.core"))(arch, cpu_vendor_id, interconnect, cuda_driver_version)
conflict("StdEnv/2016.4")
conflict("StdEnv/2018.3")
conflict("StdEnv/2020")
conflict("StdEnv/2023")
