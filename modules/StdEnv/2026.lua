...
-- gentoo/2026 will not load for sse3 and avx

if (mode() == "spider" and (arch == "avx2" or arch == "avx512")) then
	local coresubdir = "easybuild/modules/2026/x86-64-v3"
	local subdir = pathJoin("easybuild/modules/2026", newarch)
